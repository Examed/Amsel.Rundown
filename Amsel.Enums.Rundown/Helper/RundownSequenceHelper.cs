...
namespace Amsel.Enums.Rundown.Helper {
    ...
    {
        public static bool IsAfterTransitionHide(this ERundownMode sequence) => sequence.CompareTo(ERundownMode.TRANSITION_HIDE) > 0;

        public static bool IsAfterTransitionShow(this ERundownMode sequence) => sequence.CompareTo(ERundownMode.TRANSITION_SHOW) > 0;

        public static bool IsBeforeTransitionHide(this ERundownMode sequence) => sequence.CompareTo(ERundownMode.TRANSITION_HIDE) < 0;

        public static bool IsBeforeTransitionShow(this ERundownMode sequence) => sequence.CompareTo(ERundownMode.TRANSITION_SHOW) < 0;
