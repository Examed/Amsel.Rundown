namespace Amsel.Resources.Rundown.Functions
{
    ...
    {
        public const string SERVICE = "StreamlabsOBS.ServiceName";
        public const string METHODE = "StreamlabsOBS.MethodeName";
        public const string COLLECTION_NAME = "StreamlabsOBS.SceneCollection.Name";
        public const string SCENE_NAME = "StreamlabsOBS.Scene.Name";
    }
}